...
/////////////////////////////////////////////////////////////////////
// PRH DEBUGGING FUNCTIONS
/////////////////////////////////////////////////////////////////////
// These have to be someplace to be linked in.
// This is currently the lowest level place I could find
//
// I  could not figure out how to add a cpp file to wxWidgets
    ...
    // dbg defaults to 5 so 5 turns everything on by default
{
    ...
    char dbg_str[255];
    strcpy(dbg_str,"PRH_WX_DEBUG_");
    strcat(dbg_str,dbg);
    int dbg_level = prhGetEnvInt(dbg_str,5);
    
    if (dbg_level <= prh_debug_level)
    {
        char indent[255];
        strcpy(indent,"    ");
        int ctr = level;
